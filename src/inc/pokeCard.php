<div class="card" id="pokeCard0">
    <?php if (isset($userData)) { ?>
        <p class="favorite-count with-icon"><?php echo $db->getCountFavoritePokemon($pokemon->getId(), false) ?: 0 ?></p>
        <?php if ($pokemonIdArray && in_array($pokemon->getId(), $pokemonIdArray)) {
    ...
    <div class="card-body">
        ...
        <div id="FlavorText" class="carousel slide" data-ride="carousel">
            ...
            <a class="carousel-control-prev" href="#FlavorText" role="button" data-slide="prev">
                <i class="fas fa-chevron-left"></i>
            </a>
            <a class="carousel-control-next" href="#FlavorText" role="button" data-slide="next">
